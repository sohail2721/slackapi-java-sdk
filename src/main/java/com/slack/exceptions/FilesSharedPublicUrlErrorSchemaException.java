...
public class FilesSharedPublicUrlErrorSchemaException extends ApiException {
     ...
     */
    public FilesSharedPublicUrlErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this FilesSharedPublicUrlErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "FilesSharedPublicUrlErrorSchemaException [" + "statusCode=" + getResponseCode()
