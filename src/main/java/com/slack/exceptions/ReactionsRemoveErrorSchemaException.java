...
public class ReactionsRemoveErrorSchemaException extends ApiException {
     ...
     */
    public ReactionsRemoveErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this ReactionsRemoveErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReactionsRemoveErrorSchemaException [" + "statusCode=" + getResponseCode()
