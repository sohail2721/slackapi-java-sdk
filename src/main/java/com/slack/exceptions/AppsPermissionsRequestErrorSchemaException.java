...
public class AppsPermissionsRequestErrorSchemaException extends ApiException {
     ...
     */
    public AppsPermissionsRequestErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this AppsPermissionsRequestErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AppsPermissionsRequestErrorSchemaException [" + "statusCode=" + getResponseCode()
