...
```java
AdminAppsApprovedController adminAppsApprovedController = client.getAdminAppsApprovedController();
```
...
adminAppsApprovedController.adminAppsApprovedListAsync(token, null, null, null, null).thenAccept(result -> {
