...
```java
AdminInviteRequestsDeniedController adminInviteRequestsDeniedController = client.getAdminInviteRequestsDeniedController();
```
...
adminInviteRequestsDeniedController.adminInviteRequestsDeniedListAsync(token, null, null, null).thenAccept(result -> {
