...
public class PinsRemoveErrorSchemaException extends ApiException {
     ...
     */
    public PinsRemoveErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this PinsRemoveErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PinsRemoveErrorSchemaException [" + "statusCode=" + getResponseCode() + ", message="
