...
public class AuthTestErrorSchemaException extends ApiException {
     ...
     */
    public AuthTestErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this AuthTestErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AuthTestErrorSchemaException [" + "statusCode=" + getResponseCode() + ", message="
