...
public class RemindersDeleteErrorSchemaException extends ApiException {
     ...
     */
    public RemindersDeleteErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this RemindersDeleteErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RemindersDeleteErrorSchemaException [" + "statusCode=" + getResponseCode()
