...
public class RtmConnectErrorSchemaException extends ApiException {
     ...
     */
    public RtmConnectErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this RtmConnectErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RtmConnectErrorSchemaException [" + "statusCode=" + getResponseCode() + ", message="
