...
public class RemindersAddErrorSchemaException extends ApiException {
     ...
     */
    public RemindersAddErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this RemindersAddErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RemindersAddErrorSchemaException [" + "statusCode=" + getResponseCode()
