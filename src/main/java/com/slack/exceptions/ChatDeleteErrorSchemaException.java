...
public class ChatDeleteErrorSchemaException extends ApiException {
     ...
     */
    public ChatDeleteErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this ChatDeleteErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ChatDeleteErrorSchemaException [" + "statusCode=" + getResponseCode() + ", message="
