...
public class ChatUnfurlErrorSchemaException extends ApiException {
     ...
     */
    public ChatUnfurlErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this ChatUnfurlErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ChatUnfurlErrorSchemaException [" + "statusCode=" + getResponseCode() + ", message="
