...
public class PinsListErrorSchemaException extends ApiException {
     ...
     */
    public PinsListErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this PinsListErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PinsListErrorSchemaException [" + "statusCode=" + getResponseCode() + ", message="
