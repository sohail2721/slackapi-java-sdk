...
public class MigrationExchangeErrorSchemaException extends ApiException {
     ...
     */
    public MigrationExchangeErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this MigrationExchangeErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MigrationExchangeErrorSchemaException [" + "statusCode=" + getResponseCode()
