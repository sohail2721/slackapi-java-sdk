...
| `Usergroups` | [`List<SubteamUsergroupObject>`](../../doc/models/subteam-usergroup-object.md) | Required | - | List<SubteamUsergroupObject> getUsergroups() | setUsergroups(List<SubteamUsergroupObject> usergroups) |
