...
public class DndEndSnoozeErrorSchemaException extends ApiException {
     ...
     */
    public DndEndSnoozeErrorSchemaException(String reason, Context context) {
    ...
    /**
     * Converts this DndEndSnoozeErrorSchemaException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DndEndSnoozeErrorSchemaException [" + "statusCode=" + getResponseCode()
